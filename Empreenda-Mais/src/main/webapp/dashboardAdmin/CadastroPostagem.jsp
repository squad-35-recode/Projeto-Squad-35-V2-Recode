...
<head>
<meta charset="UTF-8">
<title>ADM - Fazer Postagem</title>
								...
								<div class="card text-black" style="border-radius: 25px;">
									<div class="card-body p-md-5">
										<div class="row justify-content-center">
											...
											<div>
												<h1 class="text-center mb-3">Fazer Postagem</h1>
												<form class="mx-1 mx-md-4 mt-2"
													action="<%=request.getContextPath()%>/FazerPostagemAdmin"
													id="formPerfil" method="post">
													<input type="hidden" name="id_usuario" value="6"></input>
													<div
														class="d-flex flex-row flex-wrap align-items-center mb-4 mt-3">
														<div class="form-outline flex-fill mx-1 mb-0">
															<label class="form-label" for="titulo">Título da
																Postagem</label> <input type="text" id="titulo"
																class="form-control" name="titulo"
																maxlength="100" required />
														</div>
														<div class="form-outline flex-fill mx-1 mb-0">
															<label class="form-label" for="tipoPacote">Categoria
															</label> <select id="tipoPacote" class="form-control form-select"
																name="categoria">
													...
													<div class="d-flex flex-row align-items-center mb-4">
														<div class="form-outline flex-fill mb-0">
															<label class="form-label" for="textArea">Descrição
																Longa: </label>
															<textarea id="textArea" name="corpo" maxlength="4500"
																placeholder="Insira o corpo da postagem"></textarea>
														</div>
													</div>
													...
													<div
														...
														<button type="submit" class="btn btn-success btn-lg">Fazer Postagem</button>
													</div>
												</form>
