...
<head>
<meta charset="UTF-8">
<title>Colaborador - Criar Curso</title>
								...
								<div class="card text-black" style="border-radius: 25px;">
									<div class="card-body p-md-5">
										<div class="row justify-content-center">
											...
											<div>
												<h1 class="text-center mb-3">Criar Curso</h1>
												<form class="mx-1 mx-md-4 mt-2"
													action="<%=request.getContextPath()%>/CriarCurso"
													id="formPerfil" method="post">
													<input type="hidden" name="id_usuario" value="3"></input>
													<div
														class="d-flex flex-row flex-wrap align-items-center mb-4 mt-3">
														<div class="form-outline flex-fill mx-1 mb-0">
															<label class="form-label" for="titulo">Título do Curso</label> <input type="text" id="titulo"
																class="form-control" name="titulo"
																maxlength="100" required />
														</div>
														<div class="form-outline flex-fill mx-1 mb-0">
															<label class="form-label" for="categoria">Categoria
															</label> <select id="categoria" class="form-control form-select"
																name="categoria">
													...
													<div class="d-flex flex-row align-items-center mb-4">
														<div class="form-outline flex-fill mb-0">
															<label class="form-label" for="textArea">Descrição do Curso: </label>
															<textarea id="textArea" name="descricao" maxlength="4500"
													...
													<div
														...
														<p>Cole o link da imagem de capa:</p>
															<div class="input-group mb-3">
																<span class="input-group-text" id="basic-addon3"><i
																	class="far fa-image"></i></span> 
																	<input type="text"
																	class="form-control" name="foto_capa" id="basic-url"
																	aria-describedby="basic-addon3" placeholder="http://...">
															</div>
														</div>
													</div>
													...
													<div
														...
														<div class="form-outline flex-fill mb-0 w-50 mx-1">
														<p>Cole o link da sua playlist do Youtube aqui:</p>
															<div class="input-group mb-3">
																<span class="input-group-text" id="basic-addon3"><i
																	class="far fa-image"></i></span> 
																	<input type="text"
													...
													<div
														...
														<button type="submit" class="btn btn-success btn-lg">Criar Curso</button>
													</div>
												</form>
