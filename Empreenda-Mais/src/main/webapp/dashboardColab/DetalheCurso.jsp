...
<head>
<meta charset="UTF-8">
<title>Colaborador - Detalhe do Curso</title>
						...
						<ul class="navbar-nav d-flex align-items-center">
							...
							<li class="dropdown"><a href="#"
								...
								<ul class="dropdown-menu dropdown-menu-dark text-small shadow"
									...
									<li><a class="dropdown-item" href="./dashboardColab/CadastroInscricao.jsp">Cadastrar</a></li>
								</ul></li>
		...
		<div class="container-fluid mb-3 conteudo">
			...
			<main class="col pt-2 pb-4">
						...
						<div class="card mb-4">
							<div class="card-body">
								<div class="row">
									...
									<div class="col-sm-9">
										<p class="text-muted mb-0">${curso.id}</p>
									</div>
								</div>
								<hr>
								<div class="row">
								...
								<div class="row">
									<div class="col-sm-3">
										<p class="mb-0">Data da Criação</p>
									</div>
									<div class="col-sm-9">
										<p class="text-muted mb-0">
											<span class="dataConvert">${curso.data_criacao}</span>
										</p>
									</div>
								</div>
								<hr>
								<div class="row">
									...
									<div class="col-sm-9">
										<p class="text-muted mb-0">${curso.descricao}</p>
									</div>
								</div>
								<hr>
								<div class="row">
									...
									<div class="col-sm-9">
										<p class="text-muted mb-0">${curso.categoria}</p>
									</div>
								</div>
								<hr>
								<div class="row">
									<div class="col-sm-3">
										<p class="mb-0">Foto de Capa</p>
									</div>
									<div class="col-sm-9">
										${curso.foto_capa}
									</div>
									<div class="col-sm-9">
										<img src="${curso.foto_capa}">
									</div>
								</div>
								<hr>
								<div class="row">
									<div class="col-sm-3">
										<p class="mb-0">Mídia do Curso</p>
									</div>
									<div class="col-sm-9">
										${curso.media_url}
									</div>
				...
				<div class="d-flex justify-content-center my-3">
					<a href="/Empreenda-Mais/ListarCursosColab"
