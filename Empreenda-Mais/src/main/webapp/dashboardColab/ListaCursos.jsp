...
<head>
<meta charset="UTF-8">
<title>Colab - Lista de Cursos</title>
...
<script src="./dashboardColab/js/deleteCurso.js"></script>
				...
				<form>
					<div class="table-responsive">
						<table class="table table-hover text-center">
							<thead>
								<tr>
									<td scope="col" class="headerTable text-white">Id Curso</td>
									<td scope="col" class="headerTable text-white">Título</td>
									<td scope="col" class="headerTable text-white">Categoria</td>
									<td scope="col" class="headerTable text-white">Data da Criação</td>
								</tr>
							</thead>
							<jstl:forEach items="${cursos}" var="curso">
								<tbody>
									<tr scope="row">
										...
										<td><span class="dataConvert">${curso.data_criacao}</span></td>
										<td>${reserva.num_passageiros}</td>
										<td>
											<div class="d-flex justify-content-start">
												<!-- Modificar o caminho antes de ? para o servlet correto -->
												<a
													href="/Empreenda-Mais/DetalheCursoColab?id=${curso.id}"
												...
												<!-- Modificar o caminho antes de ? para o servlet correto -->
												<a
													href="/Empreenda-Mais/AtualizarCursoColab?id=${curso.id}"
													style="cursor: pointer;"
												...
												<!-- Modificar o caminho antes de ? para o servlet correto -->
												<a href="#" onclick="confirmarDeletar(${curso.id})"
													style="cursor: pointer;"
