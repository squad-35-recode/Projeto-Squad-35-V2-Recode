				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse flex-row-reverse"
						...
						<ul class="navbar-nav d-flex align-items-center">
							<li class="nav-item"><a href="./dashboardColab/Dashboard.jsp" class="nav-link active">
		...
		<div class="container-fluid conteudo mb-3">
			<main class="row overflow-auto mb-3">
				<div class="col pt-4 pb-4">
					...
					<h3>Olá, ${sessionScope.nomeCliente}</h3>
					  ...
					  <div class="col-sm-5 mb-3">
					    <div class="card">
					      <div class="card-body">
					        ...
					        <p class="card-text">Acesse dados referentes aos cursos. Atualize, delete ou cadastre novos</p>
					        <div class="d-flex justify-content-center">
					         	<a href="/Empreenda-Mais/ListarCursosColab" class="btn btn-primary mx-2">Lista de Cursos</a>
					        	<a href="./CadastroCurso.jsp" class="btn btn-primary mx-2">Cadastro de Curso</a>
					        </div>
					  ...
					  <div class="col-sm-5">
					    <div class="card">
					      <div class="card-body">
					        ...
					        <p class="card-text">Acesse dados referentes às inscrições </p>
					        <div class="d-flex justify-content-center">
					         	<a href="/Empreenda-Mais/ListarInscricoesColab" class="btn btn-primary mx-2">Lista de Inscrições</a>
					        </div>
					      </div>
					    </div>
					  </div>
