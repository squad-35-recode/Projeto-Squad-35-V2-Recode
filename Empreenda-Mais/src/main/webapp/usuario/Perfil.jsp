...
<script>
	...
	if (parametros.attPost === 'true') {
		var aviso = document.getElementById('avisoPost');
...
<body style="margin-top: 0 !important;">
	...
	<div class="toast align-items-center top-25 avisoPerfil" id="avisoPost" style="display: none;" aria-live="assertive"
		aria-atomic="true" role="alert">
		<div class="toast-body p-3 bg-danger text-white d-flex justify-content-center align-items-center">
			<i class="fas fa-info-circle fs-1"></i>
			<p class="px-2 text-white">Postagem excluída com sucesso <br> Clique para fechar</p>
			</div>
	</div>
	<!-- Menu Principal -->
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu text-center"
							...
							<li><a class="dropdown-item" href="#"><i
									class="fas fa-user-circle fs-4 px-1"></i> <span>Nome de
										Usuário</span></a></li>
	...
	<div class="container">
	<a href="#topo" id="botao-topo" title="Voltar ao Topo">
	    <i class="fas fa-chevron-up text-primary fs-2 rounded-circle bg-light px-3 py-3 shadow-sm float-end position-fixed bottom-0 end-0 m-3" ></i>
	</a>
						...
						<div class="card-body">
							<div class="d-flex flex-column align-items-center text-center">
								...
								<div class="rounded imgPerfilUsuario p-0 shadow-sm">
									<img src="${perfil.foto_url}" class="img-fluid imgPerfilUsuario2" />
								</div>
								</c:forEach>
								<div class="mt-3">
									...
									<c:forEach items="${perfil}" var="perfil">
									<p class="text-secondary mb-1"><span id="ocup">${perfil.ocupacao}</span></p>
									<p class="text-muted font-size-sm"><span>${perfil.cidade}</span>/ <span>${perfil.uf}</span></p>
									<div class="mt-3">
						...
						<div class="card-body">
							...
							<c:forEach items="${perfil}" var="perfil">
								...
								<div class="row">
									...
									<div class="col-sm-9 text-secondary"><span id="logradouro">${perfil.logradouro}</span>, <span id="cidade">${perfil.cidade}</span>/ <span id="uf">${perfil.uf}</span></div>
								</div>
							</c:forEach>
							<hr>
							<div class="row">
								<div class="col-sm-12">
									<a class="btn btn-info "
										href="/Empreenda-Mais/EditarPerfil">Editar</a>
								</div>
							</div>
						</div>
					</div>
					...
					<ul class="timeline">
						<li>
							...
							<div class="timeline-time">
								<span class="date">Postado em</span>
								<span class="date dataConvert">${postagem.data_postagem}</span>
							...
							<div class="timeline-body">
								<div class="timeline-header">
									<span class="userimage"><img
										...
										class="username"><a href="javascript:;">${postagem.nome_usuario}</a> <small></small></span>
									<span class="pull-right text-muted">320 Visualizações</span>
								</div>
								...
								<div class="timeline-footer">
										...
										class="fa fa-comments fa-fw fa-lg m-r-3"></i> Comentar</a> 
										<a
										href="javascript:;" class="m-r-15 text-inverse-lighter"><i
										class="fa fa-share fa-fw fa-lg m-r-3"></i> Compartilhar</a>
										<a
										href="ExcluirPostagem?idPostagem=${postagem.id}" class="m-r-15 text-inverse-lighter text-danger float-end">
										<i class="fas fa-minus-circle fa-fw fa-lg m-r-3"></i> Excluir</a>
								</div>
